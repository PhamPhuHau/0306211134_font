      ...
      <div class="col-lg-10 col-xl-8">
        <div class="card" style={{borderradius: '10px'}}>
          <div class="card-header px-4 py-5">
            <h5 class="text-muted mb-0">Thanks for your Order, <span style={{color: '#a8729a'}}>Haudeptrai</span>!</h5>
          </div>
          ...
          <div class="card-footer border-0 px-4 py-5"
            ...
            <h5 class="d-flex align-items-center justify-content-end text-black text-uppercase mb-0">Total
              ...
              <button type="button" class="btn btn-primary btn-lg" style={{margin: '20px 0 0px 500px'}}>THANH TOÁN</button>
          </div>
        </div>
      </div>
    </div>
